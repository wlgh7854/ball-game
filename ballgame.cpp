...
int main()
{
    ...
    timerText.setPosition(10.f, gameHeight - 30.f);
    ...
    while (window.isOpen())
    {
        ...
        if (isPlaying)
        {
            ...
            if (ball.getPosition().x - ballRadius < 0.f)
            {
                ...
                rightScore++;
                if (rightScore >= 5) {
                    pauseMessage.setString("Game Over! You Lost!\n\nPress space to restart or\nescape to exit.");
                    isPlaying = false;
                    leftScore = 0;
                    rightScore = 0;
                } else {
            ...
            if (ball.getPosition().x + ballRadius > gameWidth)
            {
                ...
                leftScore++;
                if (leftScore >= 5) {
                    pauseMessage.setString("Game Over! You Won!\n\nPress space to restart or\nescape to exit.");
                    isPlaying = false;
                    leftScore = 0;
                    rightScore = 0;
                } else {
            ...
            // Check elapsed time to change ball color and update score
            ...
            else if (elapsedTime.asSeconds() >= 30)
            {
        ...
        // Draw the paddles, ball, pause message, score, and timer
        if (isPlaying)
        {
